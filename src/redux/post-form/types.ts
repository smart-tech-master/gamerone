...
export const AUTO_CROP_IMAGE = 'post-form/AUTO_CROP_IMAGE';
...
export interface AutoCropImageAction {
  type: typeof AUTO_CROP_IMAGE;
  payload: AutoCropImageActionPayload;
}

export interface AutoImageCroppedAction {
  type: typeof AUTO_IMAGE_CROPPED;
  payload: AutoCropImageActionPayload;
}

export interface AutoCropImageActionPayload {
  id: number;
  blobUrl: string;
}
