 ...
 */
export const following = (page = 0) => {
  return request<PagedResponse>(`/following?page=${page}`, OPTIONS);
};

/**
 * List followers
 */
export const followers = (page = 0) => {
  return request<PagedResponse>(`/followers?page=${page}`, OPTIONS);
};
